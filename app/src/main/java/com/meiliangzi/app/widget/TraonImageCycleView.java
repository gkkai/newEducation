 ...
 * 广告图片自动轮播控件</br>
 */
public class TraonImageCycleView extends LinearLayout {
    /**
     * 上下文
     */
     ...
     * @param context
     */
    public TraonImageCycleView(Context context) {
        super(context);
    }
     ...
     * @param attrs
     */
    public TraonImageCycleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    private class ImageCycleAdapter extends PagerAdapter {
         ...
         * 图片资源列表
         */
        private List<TrainBannerBean.DataBean> mAdList = new ArrayList<TrainBannerBean.DataBean>();
        ...
        public ImageCycleAdapter(Context context, List<TrainBannerBean.DataBean> adList, ImageCycleViewListener imageCycleViewListener) {
...
//			return mAdList.size();
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            TrainBannerBean.DataBean dataBean = mAdList.get(position % mAdList.size());
     ...
     */
    public void setImageResources(List<TrainBannerBean.DataBean> imageUrlList, ImageCycleViewListener imageCycleViewListener) {
        // 清除
