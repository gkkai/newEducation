...
public class IntentUtils {
    ...
    public static void startAtyWithSingleParam(Context context, Class<?> cls, String key, int value)
    {
        Intent intent = new Intent(context, cls);
        intent.putExtra(key, value);
        context.startActivity(intent);
    ...
    public static void startAtyForResult(Activity aty, Class<?> cls, int requestCode, String key, String value) {
        Intent intent = new Intent(aty, cls);
        intent.putExtra(key, value);
        aty.startActivityForResult(intent, requestCode);
    }

    public static void startAtyForResult(Activity aty, Class<?> cls, int requestCode, String key, int value) {
        Intent intent = new Intent(aty, cls);
        intent.putExtra(key, value);
        aty.startActivityForResult(intent, requestCode);
    }

    public static void startAtyForResult(Fragment fragment, Class<?> cls, int requestCode, String key, String value) {
    ...
    public static void startAtyWithParialObj(Context context, Class<?> cls, String key, Parcelable obj) {
        Intent intent = new Intent(context, cls);
        intent.putExtra(key, obj);
        context.startActivity(intent);
    }
