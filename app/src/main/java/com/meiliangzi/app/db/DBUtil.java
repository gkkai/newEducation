...
public class DBUtil {
    ...
    public void insertData(ContentValues values) {
        mSQLiteDatabase.insert(SQLHelper.TABLE_MESSAGE, null, values);
    }
    ...
    public void updateData(ContentValues values, String whereClause,
                           String[] whereArgs) {
        mSQLiteDatabase.update(SQLHelper.TABLE_MESSAGE, values, whereClause,
                whereArgs);
    }
    ...
    public void deleteData(String whereClause, String[] whereArgs) {
        mSQLiteDatabase
                .delete(SQLHelper.TABLE_MESSAGE, whereClause, whereArgs);
    }
    ...
    public Cursor selectData(String[] columns, String selection,
                             ...
                             String orderBy) {
        Cursor cursor = mSQLiteDatabase.query(SQLHelper.TABLE_MESSAGE, columns, selection, selectionArgs, groupBy, having, orderBy);
        return cursor;
    }
