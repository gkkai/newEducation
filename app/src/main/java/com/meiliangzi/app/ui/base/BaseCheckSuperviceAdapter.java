...
public abstract class BaseCheckSuperviceAdapter<T> extends BaseAdapter {
    ...
    public BaseCheckSuperviceAdapter(Context context, int itemID) {
    ...
    public BaseCheckSuperviceAdapter(Context context, XListView xListView, int itemID) {
        this.mContext = context;
    ...
    public BaseCheckSuperviceAdapter(Context context, GridView gridView, int itemID) {
        this.mContext = context;
