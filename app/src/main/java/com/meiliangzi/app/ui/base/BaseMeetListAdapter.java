...
public abstract class BaseMeetListAdapter<T> extends BaseAdapter {
    ...
    public BaseMeetListAdapter(Context context, int itemID) {
    ...
    public BaseMeetListAdapter(Context context, XListView xListView, int itemID) {
        this.mContext = context;
    ...
    public BaseMeetListAdapter(Context context, GridView gridView, int itemID) {
        this.mContext = context;
