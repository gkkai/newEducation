...
public class ListCountyAdapter<T> extends BaseAdapter {
    private LayoutInflater mLayoutInflater;
    private Context mContext;
    private List<T> mData;
    String type="1";
    public ListCountyAdapter(Context context, List<T> mData) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        holder.tv_title.setText(((CountyListbean.DataBean)mData.get(position)).getName());
        return convertView;
    }
