...
public abstract class BaseNewsAdapter<T> extends BaseAdapter {
    ...
    public BaseNewsAdapter(Context context, int itemID) {
    ...
    public BaseNewsAdapter(Context context, XListView xListView, int itemID) {
        this.mContext = context;
    ...
    public BaseNewsAdapter(Context context, GridView gridView, int itemID) {
        this.mContext = context;
