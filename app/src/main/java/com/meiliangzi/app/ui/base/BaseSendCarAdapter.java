...
public abstract class BaseSendCarAdapter<T> extends BaseAdapter {
    ...
    public  void convert(ViewHolder helper, T item, int pos){};
    public BaseSendCarAdapter(Context context, int itemID) {
    ...
    public BaseSendCarAdapter(Context context, XListView xListView, int itemID) {
        this.mContext = context;
    ...
    public BaseSendCarAdapter(Context context, GridView gridView, int itemID) {
        this.mContext = context;
...
//    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder viewHolder = ViewHolder.get(mContext, convertView, parent, mItemID, position);
