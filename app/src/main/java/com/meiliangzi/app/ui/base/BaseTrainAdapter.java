...
public abstract class BaseTrainAdapter<T> extends BaseAdapter {
    ...
    public BaseTrainAdapter(Context context, int itemID) {
    ...
    public BaseTrainAdapter(Context context, XListView xListView, int itemID) {
        this.mContext = context;
    ...
    public BaseTrainAdapter(Context context, GridView gridView, int itemID) {
        this.mContext = context;
