...
public abstract class BaseLoctionsAdapter<T> extends BaseAdapter {
    ...
    public BaseLoctionsAdapter(Context context, int itemID) {
    ...
    public BaseLoctionsAdapter(Context context, XListView xListView, int itemID) {
        this.mContext = context;
